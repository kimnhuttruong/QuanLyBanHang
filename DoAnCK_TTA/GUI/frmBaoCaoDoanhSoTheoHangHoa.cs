...
{
    public partial class frmBaoCaoDoanhSoTheoHangHoa : DevExpress.XtraEditors.XtraUserControl
    {
        public frmBaoCaoDoanhSoTheoHangHoa()
        {
            InitializeComponent();
        }

        private void frmBaoCaoDoanhSoTheoHangHoa_Load(object sender, EventArgs e)
        {
